...
// Image Condition Check
    if ($files["size"] > 50*1000000) {
        ...
        header("Location:add-product.php?error=Sorry, only JPG, JPEG, PNG & GIF files are allowed.");
    } else if ($files["type"] == "image/jpeg" || $files["type"] == "image/png" || $files["type"] == "image/jpg" || $files["type"] == "image/gif" || $files["type"] == ""){
